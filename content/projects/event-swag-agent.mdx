...
* **Power-Platform-first is a deliberate tradeoff.** Less flexibility in exchange for native identity and governance, which is worth it when the tool has to live inside an existing org.
