...
The point of all of it is consistency. A model will happily build the wrong thing very fast. The skills and plugins are there to make sure speed doesn't come at the cost of building the wrong thing.

## What I learned

* **Ease of use wins.** If it takes effort, it won't get adopted.
...
* **AI accelerates mistakes.** Speed is a trap if you're not disciplined. The bottleneck stops being typing and becomes knowing what you actually want.
