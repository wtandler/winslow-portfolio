...
summary: Real-time AI research synthesis for hedge-fund rates PMs—compares what markets, dealers, the Street, and the data say, then flags where they disagree.
date: 2026-05
...
{/* DRAFT — please confirm/adjust: (1) live URL if/when public, (2) whether to keep status "in-progress" vs "live", (3) anything you'd rather not disclose. Repo is private, so no github link. */}
